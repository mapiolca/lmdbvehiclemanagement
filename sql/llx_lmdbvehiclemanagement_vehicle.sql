CREATE TABLE llx_lmdbvehiclemanagement_vehicle (
	...
	fk_asset_type integer DEFAULT NULL,
	eu_category varchar(16) DEFAULT NULL,
	national_genre varchar(32) DEFAULT NULL,
	gvw_kg double(24,8) DEFAULT NULL,
	gcw_kg double(24,8) DEFAULT NULL,
	seats integer DEFAULT NULL,
	regulatory_territory varchar(32) DEFAULT 'FR_METRO' NOT NULL,
