...
$permissiontoadd = (isModEnabled('lmdbvehiclemanagement') && empty($user->socid) && $user->hasRight('lmdbvehiclemanagement', 'event', 'write')) ? 1 : 0;
...
$hookmanager->initHooks(array('lmdbvehicleeventdocument', 'globalcard'));
...
print dol_get_fiche_head($head, 'documents', $langs->trans('VehicleEvent'), -1, $object->picto);
...
dol_banner_tab($object, 'ref', $linkback, 1, 'ref', 'ref', '<div class="refidno">'.dol_escape_htmltag($object->label).'</div>');
