...
checkSharing($xpath->query('//form|//*[@id="qx-sharing-open"]')->length === 0 && $xpath->query('//*[@id="qx-view-switch"]')->length === 1, 'Global QUARTIX sharing exposes only usage/mileage navigation');
