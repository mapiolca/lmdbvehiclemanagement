...
checkSharing($xpath->query('//div[@class="tabsAction"]/a')->length === 2 && $xpath->query('//*[@id="qx-sharing-open"]')->length === 1 && $xpath->query('//input[@name="token"]')->length === 1, 'Mileage and sharing actions share the native action bar with one protected form');
