...
class InterfaceLmdbVehicleManagementTriggers extends DolibarrTriggers
{
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
		...
		$actions = array(
			...
			'LMDBVEHICLEMANAGEMENT_CONSUMPTION_CREATE',
			'LMDBVEHICLEMANAGEMENT_CONSUMPTION_UPDATE',
			'LMDBVEHICLEMANAGEMENT_CONSUMPTION_DELETE',
			'LMDBVEHICLEMANAGEMENT_EVENT_CREATE',
			'LMDBVEHICLEMANAGEMENT_EVENT_UPDATE',
			'LMDBVEHICLEMANAGEMENT_EVENT_DELETE',
			'LMDBVEHICLEMANAGEMENT_INSURANCE_CONTRACT_CREATE',
			'LMDBVEHICLEMANAGEMENT_INSURANCE_CONTRACT_UPDATE',
			'LMDBVEHICLEMANAGEMENT_INSURANCE_CONTRACT_DELETE',
			'LMDBVEHICLEMANAGEMENT_INSURANCE_CERTIFICATE_CREATE',
			'LMDBVEHICLEMANAGEMENT_INSURANCE_CERTIFICATE_UPDATE',
			'LMDBVEHICLEMANAGEMENT_INSURANCE_CERTIFICATE_DELETE',
		);
