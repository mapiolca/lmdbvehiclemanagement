...
`lmdbvehiclemanagement` fournit un dossier véhicule multientité intégré à Dolibarr. La version `0.8.6` couvre les véhicules, leurs affectations, leurs relevés kilométriques, leurs consommations, leurs événements métier et leurs contrats d’assurance.
...
## Fonctionnalités de la version 0.8.6
