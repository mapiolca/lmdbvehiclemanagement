...
`lmdbvehiclemanagement` fournit un dossier véhicule multientité intégré à Dolibarr. La version `0.1.1` couvre les véhicules, leurs affectations, les relevés kilométriques et les événements métier.
...
## Fonctionnalités de la version 0.1.1
