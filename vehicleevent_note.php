...
$permissionnote = (isModEnabled('lmdbvehiclemanagement') && empty($user->socid) && $user->hasRight('lmdbvehiclemanagement', 'event', 'write'));
...
print dol_get_fiche_head($head, 'notes', $langs->trans('VehicleEvent'), -1, $object->picto);
