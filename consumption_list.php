...
$selectedfields = $form->multiSelectArrayWithCheckbox('selectedfields', $arrayfields, 'lmdbvehicleconsumptionlist', 0);
print '<div class="div-table-responsive-no-min"><table class="tagtable nobottomiftotal noborder liste"><tr class="liste_titre_filter">';
