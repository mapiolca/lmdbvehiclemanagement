...
print '<tr class="oddeven"><td>'.$langs->trans('ReminderHorizonsDays').'</td><td>'.$form->multiselectarray('reminder_horizons', $reminderHorizonOptions, array_map('intval', $horizons), 0, 0, 'minwidth300').'</td></tr><tr class="oddeven"><td>'.$langs->trans('DueSoonDays').'</td><td><input class="flat width75" inputmode="numeric" name="due_soon_days" value="'.getDolGlobalInt('LMDBVEHICLEMANAGEMENT_CONTROL_DUE_SOON_DAYS', 90).'"></td></tr>';
...
print '</table></div><div class="center"><input type="submit" class="button button-save" value="'.$langs->trans('CreateRegulatoryRuleOverride').'"></div></form>';
...
print '</table></div><div class="center"><input type="submit" class="button button-save" value="'.$langs->trans('CreateCustomRegulatoryRule').'"></div></form>';
