...
$permissionToWrite = (isModEnabled('lmdbvehiclemanagement') && empty($user->socid) && $user->hasRight('lmdbvehiclemanagement', 'event', 'write'));
...
if ($action === 'create' || $action === 'edit') {
	...
	print '<tr><td class="tdtop">'.$langs->trans('Description').'</td><td><textarea class="flat quatrevingtpercent" rows="4" name="description">'.dol_escape_htmltag((string) $object->description).'</textarea></td></tr>';
