...
- Modèle natif **Dossier véhicule** : PDF récapitulatif de tout l’historique disponible et ZIP des originaux du véhicule, des interventions et des factures, sans justificatifs de consommation. Les prix inconnus, zéros, devises et statuts sont conservés ; les documents absents sont signalés. Les dictionnaires d’énergies et de consommables fournissent leur libellé au rendu natif, afin de permettre la génération lorsque ces champs sont renseignés.
