...
- Réactiver le module après cette mise à jour pour ajouter la date d’installation, configurer QUARTIX, confirmer les unités/fuseaux, associer les véhicules puis activer les trois tâches. Si l'intégration est déjà initialisée, compléter et enregistrer le nouveau champ **APPLICATION NAME** fourni par QUARTIX, sans nouvelle saisie du mot de passe. Voir [le guide QUARTIX](doc/quartix.md). Version du module inchangée.
