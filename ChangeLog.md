...
- Sécurisation transactionnelle de la qualification, migration conservatrice des anciens profils `SPECIAL_PUBLIC`, archivage limité aux contrôles annulés ou remplacés et centralisation des droits métier administrateur/Multicompany.
...
- Extension des contrôles contractuels sur les règles, traductions, droits, interfaces, Agenda, cron, migration et compatibilité Dolibarr v20/PHP 8.0 ; déclaration explicite des propriétés de retour de hooks pour supprimer les avertissements de propriétés dynamiques sous PHP 8.2+, sans réécriture des événements ou contrôles validés existants.
