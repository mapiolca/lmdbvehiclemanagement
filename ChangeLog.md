...
- Correction du chargement de la classe de compatibilité avant l’affichage des modèles de dossier dans les réglages, afin d’éviter une erreur fatale à l’ouverture de `admin/setup.php`, et utilisation de la traduction native du titre « Modèles de documents ».
